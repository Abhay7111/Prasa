  ...
  return (
    <div className='w-full overflow-x-hidden flex flex-col h-fit sm:flex-row items-start justify-between px-5'>
        <div className='flex relative flex-col items-start justify-between calc-css-h-full pb-10'>
            ...
            <div className='scale-[1.2] z-0 absolute sm:relative top-[400%] -right-[19%] sm:top-auto sm:right-auto overflow-hidden'>
            <Lstr/>
            </div>
        </div>
        <div className='xl:w-[68%] flex flex-col justify-end items-start z-20 relative calc-css-h-full'>
